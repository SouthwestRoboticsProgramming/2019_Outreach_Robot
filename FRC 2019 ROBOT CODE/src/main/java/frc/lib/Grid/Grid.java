...
public class Grid extends Subsystem {
   ...
   */
  public boolean startPositionTracking() {
  ...
  private void trackPosition() {
    double difL = Robot.driveSubsystem.getLeftDriveFeet() - lastLeft;
    double difR = Robot.driveSubsystem.getRightDriveFeet() - lastRight;
    ...
    lastLeft = Robot.driveSubsystem.getLeftDriveEncoder();
    lastRight = Robot.driveSubsystem.getRightDriveEncoder();
  }
